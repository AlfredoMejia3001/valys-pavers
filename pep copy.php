...
?>
<div id="modal" class="fixed inset-0 z-10 overflow-y-auto hidden bg-gray-900 bg-opacity-75">
            ...
            <div class="border-b-2 border-gray-300 pb-8 mb-8">
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                        <div class="text-gray-700 mb-2">Fecha de emision: <?php echo $row["Fecha_Emision"]; ?></div>
                    </div>
                </div>
                <div class="flex justify-between">
                    <div>
                        <div class="text-gray-700 mb-2"><?php echo $row["Direccion"]; ?></div>
                    </div>
                    <div>
                        <div class="text-gray-700 mb-2">Fecha de vencimiento: <?php echo $row["Fecha_Vencimiento"]; ?></div>
                    </div>
                </div>
